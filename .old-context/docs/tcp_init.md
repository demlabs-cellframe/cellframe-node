...
## Описание
Критическая функция ядра. tcp_init выполняет базовые операции системы Cellframe.
...
def example_tcp_init():
    try:
        result = libCellFrame.tcp.init()
