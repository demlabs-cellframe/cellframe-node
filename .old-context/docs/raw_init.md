...
## Описание
Критическая функция ядра. raw_init выполняет базовые операции системы Cellframe.
...
def example_raw_init():
    try:
        result = libCellFrame.raw.init()
