...
## Описание
Критическая функция ядра. udp_init выполняет базовые операции системы Cellframe.
...
def example_udp_init():
    try:
        result = libCellFrame.udp.init()
