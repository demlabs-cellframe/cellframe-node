#!/usr/bin/env python3
"""
Smart Layered Context - CLI v2.0

Модульная архитектура с автоматической регистрацией команд.
Использует готовые модули команд из .context/tools/cli_modules/

Версия: 2.0.0
Создано: 2025-01-25
Обновлено: 2025-01-25
Автор: SLC Development Team
"""
