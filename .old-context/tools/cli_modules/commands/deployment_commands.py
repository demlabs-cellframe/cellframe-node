#!/usr/bin/env python3
"""
Команды развертывания для Smart Layered Context
"""
...
from ..common.base_command import ContextAwareCommand
...
class CreateArchiveCommand(ContextAwareCommand):
    ...
    def __init__(self, base_path: str = None):
        ...
        self.context_dir = Path(base_path) / ".context" if base_path else Path(".context")
