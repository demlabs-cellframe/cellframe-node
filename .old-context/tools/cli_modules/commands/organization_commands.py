#!/usr/bin/env python3
"""
Organization Commands - Команды для автоматической организации файлов СЛК

Реализует команды для управления файловой организацией:
- organize - автоматическая организация файлов
- cleanup - очистка временных файлов
- monitor - мониторинг файловой системы
- stats - статистика организации
...
from tools.cli_modules.core.file_organization_engine import (
    FileOrganizationEngine, AutoCleanupSystem, quick_organize, cleanup_project
)
