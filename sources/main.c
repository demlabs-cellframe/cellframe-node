...
#if defined(DAP_OS_MACOS) || ( defined(DAP_OS_LINUX) && ! defined (DAP_OS_ANDROID)) && ! defined (DAP_OS_IOS)
...
#if defined(DAP_OS_MACOS) || ( defined(DAP_OS_LINUX) && ! defined (DAP_OS_ANDROID))
    // vpn server
