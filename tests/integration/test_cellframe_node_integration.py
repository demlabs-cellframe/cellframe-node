...
"""
        ...
        for plugin_file, should_pass in plugins_to_test:
            ...
            if should_pass:
                # We expect this to fail security validation
                if not is_secure:
                ...
                # We expect this to pass security validation
                if is_secure:
...
def load_config():
    ...
    config_file = os.path.join(os.path.dirname(__file__), "plugin_config.ini")
...
"""
        ...
        plugin_config_file = os.path.join(self.plugin_dir, "plugin_config.ini")
